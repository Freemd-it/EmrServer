...
(function () {
  let tableRenderMedicineInventory = [];
  ...
  $('input[name=inventoryMedicineSearchText]').change(() => {
    selectedCondition.searchText = '';
  });
  ...
  $('.inventory-pharmacy-search-button').on('click', () => {
    ...
    const searchText = $('input[name=inventoryMedicineSearchText]').val();
    const option = $('.inventory-medicine-search-select option:selected').val();
    const param = {
