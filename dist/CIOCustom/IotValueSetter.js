...
var IotValueSetter = function IotValueSetter() {};
...
IotValueSetter.DoorActionDetection = function (requestData) {
    ...
    switch (requestData) {
        ...
        case "0":
            object.messageBody = "창문이 닫혔습니다.";break;
        case "1":
            object.messageBody = "창문이 열렸습니다.";break;
        default:
            return false;
    }
...
IotValueSetter.LightingControl = function (requestData) {
    ...
    switch (requestData) {
        ...
        case "0":
            object.messageBody = "소등되었습니다.";break;
        case "1":
            object.messageBody = "점등되었습니다.";break;
        default:
            return false;
    }
...
IotValueSetter.GasAlarm = function (requestData) {
    ...
    switch (requestData) {
        ...
        case "0":
            object.messageBody = "대기중 가스 농도가 정상입니다.";break;
        case "1":
            object.messageBody = "대기중에 가스가 유출되었습니다. \n가스 밸브를 확인해주세요.";break;
        default:
            return false;
    }
...
IotValueSetter.DustAlarm = function (requestData) {
    ...
    if (0 < dustConcentration && dustConcentration < 31) {
        object.messageBody = "현재 대기내 미세먼지 농도는\n(" + dustConcentration + "ug/m3)로 \"좋음\" 상태입니다.";
    } else if (30 < dustConcentration && dustConcentration < 81) {
        object.messageBody = "현재 대기내 미세먼지 농도는\n(" + dustConcentration + "ug/m3)로 \"보통\" 상태입니다.";
    } else if (80 < dustConcentration && dustConcentration < 151) {
        object.messageBody = "현재 대기내 미세먼지 농도는\n(" + dustConcentration + "ug/m3)로 \"나쁨\" 상태입니다.";
    } else if (150 < dustConcentration) {
...
//# sourceMappingURL=IotValueSetter.js.map