...
var AlimTalkWaterfall = function AlimTalkWaterfall() {};
...
router.post('/alimtalk', function (req, res) {
    ...
    async.waterfall([AlimTalkWaterfall.Send = function (callback) {
...
//# sourceMappingURL=KakaoTalkMessageController.js.map