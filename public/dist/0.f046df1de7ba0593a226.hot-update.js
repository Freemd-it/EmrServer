    ...
    _jquery2.default.ajax({
        ...
        for (var _i = 0; _i < result.length; _i++) {
            ...
            if (_i === 0) {
                ...
                (0, _jquery2.default)('.small-category-select > select').nextAll('div.text').text('' + result[_i].secondaryCategory);

                (0, _jquery2.default)('.small-category-select > select').append('<option selected value=\'' + result[_i].secondaryCategory + '\'> ' + result[_i].secondaryCategory + ' </option>');
                ...
                for (var _i = 0; _i < tableRenderMedicine.length; _i++) {
                    (0, _jquery2.default)('#medicineTableBody').append('<tr id=' + tableRenderMedicine[_i].id + '>\n                       <td>' + tableRenderMedicine[_i].name + '</td>\n                       <td>' + tableRenderMedicine[_i].ingredient + '</td>\n                       <td>' + tableRenderMedicine[_i].medication + '</td>\n                       <td>' + tableRenderMedicine[_i].property + '</td>\n                </tr>');
                }
            } else {
                console.log(result[_i].secondaryCategory);
                (0, _jquery2.default)('.small-category-select > select').append('<option value=\'' + result[_i].secondaryCategory + '\'> ' + result[_i].secondaryCategory + ' </option>');
            }
        }
    });
});
