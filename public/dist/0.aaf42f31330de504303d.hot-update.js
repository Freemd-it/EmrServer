    ...
    _jquery2.default.ajax({
        ...
        for (var i = 0; i < result.length; i++) {
            if (i === 0) {
                ...
                console.log(medicine.find(function (x) {
                    if (_jquery2.default.trim(x.primaryCategory) === _jquery2.default.trim(categoryMain) && x.secondaryCategory === _jquery2.default.trim(categorySmall)) {}

                    console.log(_jquery2.default.trim(x.primaryCategory));
                    console.log(_jquery2.default.trim(categoryMain));
                }));
            } else {
