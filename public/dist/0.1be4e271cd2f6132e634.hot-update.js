...
(0, _jquery2.default)('#doctorSignedComplete').on('click', function () {
    ...
    for (var i = 1; i <= prescriptionLength; i++) {
        console.log((0, _jquery2.default)('#prescriptionTableBody').children().eq(i));
        console.log((0, _jquery2.default)('#prescriptionTableBody').children().eq(i).attr('id'));
        console.log((0, _jquery2.default)('#prescriptionTableBody').children().eq(i).children().eq(3));
        console.log((0, _jquery2.default)('#prescriptionTableBody').children().eq(i).children().eq(4));
        console.log((0, _jquery2.default)('#prescriptionTableBody').children().eq(i).children().eq(5));
        console.log((0, _jquery2.default)('#prescriptionTableBody').children().eq(i).children().eq(6));
    }
