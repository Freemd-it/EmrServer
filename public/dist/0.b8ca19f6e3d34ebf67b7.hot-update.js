...
(0, _jquery2.default)('#doctorSignedComplete').on('click', function () {
    ...
    for (var i = 1; i <= prescriptionLength; i++) {
        ...
        console.log((0, _jquery2.default)('#prescriptionTableBody').children().eq(i).children().eq(2).children());
        console.log((0, _jquery2.default)('#prescriptionTableBody').children().eq(i).children().eq(3).children());
        console.log((0, _jquery2.default)('#prescriptionTableBody').children().eq(i).children().eq(4).children());
        console.log((0, _jquery2.default)('#prescriptionTableBody').children().eq(i).children().eq(5).children());
    }
