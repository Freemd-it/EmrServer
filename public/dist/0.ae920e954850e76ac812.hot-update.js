...
(0, _jquery2.default)('#pharmacopoeia').on('click', function () {
    _jquery2.default.ajax({
        ...
        for (var i = 0; i < result.length; i++) {
            ...
            console.log(result[i].primaryCategory);
            (0, _jquery2.default)('.main-category-select').prepend('<option value=\'' + result[i].primaryCategory + '\'> ' + result[i].primaryCategory + ' </option>');
        }
    });
