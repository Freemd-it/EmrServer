...
(0, _jquery2.default)('#doctorSignedComplete').on('click', function () {
    ...
    for (var i = 1; i <= prescriptionLength; i++) {
        ...
        medicine.medicineId = (0, _jquery2.default)('#prescriptionTableBody').children().eq(i).attr('medicineName');
        medicine.medicineId = (0, _jquery2.default)('#prescriptionTableBody').children().eq(i).attr('ingredient');
        medicine.medicineId = (0, _jquery2.default)('#prescriptionTableBody').children().eq(i).attr('id');
        medicine.medicineId = (0, _jquery2.default)('#prescriptionTableBody').children().eq(i).attr('id');
        medicine.medicineId = (0, _jquery2.default)('#prescriptionTableBody').children().eq(i).attr('id');
        medicine.medicineId = (0, _jquery2.default)('#prescriptionTableBody').children().eq(i).attr('id');
