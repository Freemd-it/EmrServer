...
(0, _jquery2.default)('#doctorSignedComplete').on('click', function () {
    ...
    for (var i = 1; i <= prescriptionLength; i++) {
        ...
        // console.log($('#prescriptionTableBody').children().eq(i).attr('id'));
        // console.log($.trim($('#prescriptionTableBody').children().eq(i).children().eq(0).text()));
        // console.log($.trim($('#prescriptionTableBody').children().eq(i).children().eq(1).text()));
        // console.log($('#prescriptionTableBody').children().eq(i).children().eq(2).children().val());
        // console.log($('#prescriptionTableBody').children().eq(i).children().eq(3).children().val());
        // console.log($('#prescriptionTableBody').children().eq(i).children().eq(4).children().val());
        // console.log($('#prescriptionTableBody').children().eq(i).children().eq(5).children().val());
    }
