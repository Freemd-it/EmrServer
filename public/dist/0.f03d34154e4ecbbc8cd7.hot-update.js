...
(0, _jquery2.default)(document).on('click', '.pharmacopoeia-hover', function (e) {
    ...
    JSON.parse(window.localStorage.getItem('medicine')).find(function (x) {
        if (x.id === Number(e.currentTarget.id)) {
            (0, _jquery2.default)('#prescriptionTableBody').append('<tr id=' + x.id + '\'>\n               <td>' + x.name + '</td>\n               <td>' + x.ingredient + '</td>\n               <td><input /></td>\n               <td><input /></td>\n               <td><input /></td>\n               <td><input /></td>\n               <td class="deletePrescriptionIcon">\n                <i class="sign out icon delete-icon-size"></i>\n               </td>\n         </tr>');
...
(0, _jquery2.default)(document).on('click', '.deletePrescriptionIcon', function (e) {
    console.log((0, _jquery2.default)(e.target).parent());
});
